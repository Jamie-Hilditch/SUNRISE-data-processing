...
%% 
close % closes Example 1
%% Example 2: One direction
% This one's for all you _One Direction_ fans out there. Let's do something
% similar to Example 1.  We'll start with the |peaks| data and set the colormap
% using Stephen Cobeldick's |brewermap| function (available on the Mathworks File 
% Exchange site).  The colormap will diverge about zero, but only values on
% the positive end of the colorbar will be clipped when we set the color
