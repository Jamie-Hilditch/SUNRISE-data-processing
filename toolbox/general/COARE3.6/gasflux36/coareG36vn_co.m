function [A, G]=coareG36vn_co(u,zu,t,zt,rh,zq,P,ts,Rs,Rl,lat,zi,rain,Ss,cp,sigH,zrf_u,zrf_t,zrf_q,dCO)
%
...
G = COcalc(ut,du,Cdn_10/1000,Cd,usr,ts,tkt,dCO,xlamx,rhoa,rhow,visw,alq,f,Acoef,Bcoef);
...
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
function G=COcalc(ut,du,Cdn_10,Cd,usr,ts,tkt,dCO,xlamx,rhoa,rhow,visw,alq,f,A,B)
...
kco2=vtc;
cfb=kco2.*dCO;                   %He flux in mmol/m2/s
