function [A, Gout]=coareG36vn_co2(u,zu,t,zt,rh,zq,P,ts,Rs,Rl,lat,zi,rain,Ss,cp,sigH,zrf_u,zrf_t,zrf_q,dCO2)
%
...
Gout = CO2calc(ut,du,Cdn_10/1000,Cd,usr,ts,tkt,dCO2,xlamx,rhoa,rhow,f,Acoef,Bcoef);
...
G = [rwo ra rw vtco vtc phi sol alc scwc vtc2 kbb cfb kco2 k660];
