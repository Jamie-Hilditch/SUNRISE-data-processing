function [A, G]=coareG36vn_sf6(u,zu,t,zt,rh,zq,P,ts,Rs,Rl,lat,zi,rain,Ss,cp,sigH,zrf_u,zrf_t,zrf_q,dHe)
%
...
r1=8.314;
a=[-520.606 250.6 75.701];
b=[ -0.0117 0.0000 -0.00];
a0=[3531.6 231.4 7.2168 0.09056];
tsx=(x+273.16)/100;
s=a(1)+a(2)./tsx+a(3).*log(tsx*100)+34*(b(1)+b(2)*tsx+b(3).*tsx.*tsx);
